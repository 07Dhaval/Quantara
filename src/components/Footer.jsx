...
const Footer = () => {
  return (
    <footer className="w-full bg-[#000000] px-5 pt-16 sm:pt-20 pb-8">
      <div className="mt-[-150px] mx-auto max-w-[980px]">
        ...
        <div className="flex flex-col items-center text-center">
          <img
            src={logo}
            alt="Quantara"
            className="h-34 sm:h-60 w-auto object-contain"
          />
          <p className="mt-[-20px] max-w-[560px] text-sm sm:text-base leading-6 sm:leading-7 text-gray-400 px-2">
        ...
        {/* Gradient divider */}
        <div className="mt-6 sm:mt-16 h-px w-full bg-gradient-to-r from-transparent via-[#7B61FF] to-transparent" />
